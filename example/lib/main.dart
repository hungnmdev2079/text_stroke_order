...
class _MyAppState extends State<MyApp> {
  ...
  final _textStrokeOrderPlugin = TextStrokeOrder();
  final svg =
...
""";
  ...
  void initState() {
    ...
    final x = parser.getPathSegments();
    final x2 = parser.getTextSegments();
    print(x);
  }
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await _textStrokeOrderPlugin.getPlatformVersion() ??
